...
/* Defines needed by FreeRTOS to implement CMSIS RTOS2 API. Do not chan    ge! */
/* some config is belong to kernel 9.0.0*/
/* FIXME: change clock hz*/
#define configCPU_CLOCK_HZ                      (5000000U * 5)
...
extern void vAssertCalled( unsigned long ulLine, const char * const pcFileName, const char * const pcFuncName);
#define configASSERT( x ) if( ( x ) == 0 ) vAssertCalled(__LINE__,__FILE__,__func__)
